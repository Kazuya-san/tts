...
function CityChooser() {
  ...
  const shouldAutoRedirect = useMemo(
    () => query_stay !== '1' && zipAndCity?.city.alt_id,
    [query_stay, zipAndCity?.city.alt_id]
  )
  ...
  if (shouldAutoRedirect) {
    router.replace(query_continue ?? `/city/${zipAndCity?.city.alt_id || 1}`)
  }
            ...
            <Container>
              <div className={classes.root}>
                ...
                >
                  ...
                  <Grid item xs={12} sm={6} md={6} lg={6} xl={6}>
                    <div className={styles.cityChooser__rightSection}>
                      <div className={styles.cityChooser__imgHolder}>
                        <Image src={CityChooserImg} alt="CityChooserImg" />
                      </div>
                      <h1 className={styles.cityChooser__rightTitle}>
                        Discover the <br />
                        Services near you
                      </h1>
                    </div>
