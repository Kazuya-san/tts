          ...
          <div className={styles.login__root}>
            ...
            >
              <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                <div className={styles.login__leftSection}>
                  <div>
                    <h1 className={styles.login__rightTitle_top}>Hello!</h1>
                    <h1 className={styles.login__rightTitle_top}>
                      Welcome Back.
                      <div className={styles.login__handImo}>
                        <Image src={HandImg} alt="HandImg" />
                      </div>
                    </h1>
                  </div>
                  <div className={styles.login__imgHolder}>
                    <Image src={ClockImg} alt="ClockImg" />
                  </div>
                  <h4 className={styles.login__rightTitle_bottom}>
                    Keep the spirit up !
                  </h4>
                </div>
              </Grid>
