          ...
          <div className={styles.signUp__root}>
            ...
            >
              <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                <div className={styles.signUp__leftSection}>
                  <h1 className={styles.signUp__rightTitle_top}>
                    Thanks for being a user <br />
                    on our Website !
                  </h1>
                  <div className={styles.signUp__imgHolder}>
                    <Image src={PeopleImg} alt="PeopleImg" />
                  </div>
                  <h4 className={styles.signUp__rightTitle_bottom}>
                    Let's get started !
                  </h4>
                </div>
              </Grid>
